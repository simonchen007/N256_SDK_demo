...
#define BT_MODULE_SDP                   (0x0AU<<BT_MODULE_OFFSET) /**< Prefix of the SDP module. */
#define BT_MODULE_RFCOMM                (0x0BU<<BT_MODULE_OFFSET) /**< Prefix of the RFCOMM module. */
#define BT_MODULE_HFP                   (0x0CU<<BT_MODULE_OFFSET) /**< Prefix of the HFP module. */
#define BT_MODULE_SPP                   (0x0DU<<BT_MODULE_OFFSET) /**< Prefix of the SPP module. */
#define BT_MODULE_AVRCP                 (0x0EU<<BT_MODULE_OFFSET) /**< Prefix of the SPP module. */
#define BT_MODULE_A2DP                  (0x0FU<<BT_MODULE_OFFSET) /**< Prefix of the A2DP module. */
#define BT_MODULE_GOEP                  (0x10U<<BT_MODULE_OFFSET) /**< Prefix of the GOEP module. */
#define BT_MODULE_PBAPC                 (0x11U<<BT_MODULE_OFFSET) /**< Prefix of the PBAPC module. */
#define BT_MODULE_AWS                   (0x12U<<BT_MODULE_OFFSET) /**< Prefix of the AWS module. */
...
#define BT_STATUS_PENDING               (BT_MODULE_GENERAL|(BT_MODULE_MASK&0x01))        /**< General pending. */
#define BT_STATUS_BUSY                  (BT_MODULE_GENERAL|(BT_MODULE_MASK&0x02))        /**< General busy, please re-try the operation later. */
