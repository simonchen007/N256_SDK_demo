...
#define KI_TASK_STACK_DEF(TASK_ID,QUEUE_ID,ENTRY_POINT,STACK_SIZE,QUEUE_SIZE,PRIORITY)    \
       ATTR_GKI_STACK_IN_RAM Int32 ki##ENTRY_POINT##Stack[(M_KiRoundToN(STACK_SIZE+TCB_OVERHEAD+KI_STACK_INCREASE,8))/sizeof(Int32)];
#else
#define KI_TASK_STACK_DEF(TASK_ID,QUEUE_ID,ENTRY_POINT,STACK_SIZE,QUEUE_SIZE,PRIORITY)    \
       ATTR_GKI_STACK_IN_RAM Int32 ki##ENTRY_POINT##Stack[(M_KiRoundToLong(STACK_SIZE+TCB_OVERHEAD+KI_STACK_INCREASE))/sizeof(Int32)];
#endif
