 ...
 **************************************************************************/
/** \file
 * Internal GKI header for stack pool 3.
 **************************************************************************/
...
/* Create stack pool 3 structure */
#define KI_TASK_STACK_SETUP_POOL  3
#define KI_TASK_DEF_TYPE          KI_STACK_SETUP

/* Create structure */
typedef struct KiTaskStackPool3Tag
{
...
extern KiTaskStackPool3 kiTaskStackPool3;
