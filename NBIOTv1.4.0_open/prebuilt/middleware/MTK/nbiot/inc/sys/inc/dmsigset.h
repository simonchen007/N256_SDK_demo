...
*
*  When adding new entries, re-use the DISUSED_ entries first.
***************************************************************************/
KI_BASE_DEF (L1SI)
KI_BASE_DEF (L1AL)
KI_BASE_DEF (L1AM)
KI_BASE_DEF (DISUSED_BM)
KI_BASE_DEF (DM)
KI_BASE_DEF (USB)
KI_BASE_DEF (L1CTM)
KI_BASE_DEF (DISUSED_SP)
KI_BASE_DEF (DISUSED_IRDA)
KI_BASE_DEF (DISUSED_OBEX)
/* base def for Camera API Test Task */
KI_BASE_DEF (CATT)
KI_BASE_DEF (FS)
KI_BASE_DEF (DTF)
KI_BASE_DEF (SHMLOG)
