...
KI_BASE_DEF (MMCC)
KI_BASE_DEF (AM)
KI_BASE_DEF (AU_DDR_CHANNEL_MGR)
KI_BASE_DEF (AU_DDR_VOLUME_CTRL)
KI_BASE_DEF (AU_DDR_ROUTE_CTRL)
KI_BASE_DEF (MMSC)
KI_BASE_DEF (LARD)
KI_BASE_DEF (AU_DDR_DAI_CTRL)

KI_BASE_DEF (CSS_GCSAI)
KI_BASE_DEF (CSS_CSDI)
KI_BASE_DEF (CSS_AU)

KI_BASE_DEF (AU_ROUTER_CAL)
KI_BASE_DEF (AU_ROUTER_MGR)
KI_BASE_DEF (AU_LOWLEVEL)
  
KI_BASE_DEF (AU_STREAM_MGR)
