 ...
 **************************************************************************/
/** \file
 * Internal GKI header for stack pool 0.
 **************************************************************************/
...
/* Create stack pool 0 structure */
#define KI_TASK_STACK_SETUP_POOL  0
#define KI_TASK_DEF_TYPE          KI_STACK_SETUP

/* Create structure */
typedef struct KiTaskStackPool0Tag
{
...
extern KiTaskStackPool0 kiTaskStackPool0;
