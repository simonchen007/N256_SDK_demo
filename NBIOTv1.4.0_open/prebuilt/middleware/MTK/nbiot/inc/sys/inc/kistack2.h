 ...
 **************************************************************************/
/** \file
 * Internal GKI header for stack pool 2.
 **************************************************************************/
...
/* Create stack pool 2 structure */
#define KI_TASK_STACK_SETUP_POOL  2
#define KI_TASK_DEF_TYPE          KI_STACK_SETUP

/* Create structure */
typedef struct KiTaskStackPool2Tag
{
...
extern KiTaskStackPool2 kiTaskStackPool2;
