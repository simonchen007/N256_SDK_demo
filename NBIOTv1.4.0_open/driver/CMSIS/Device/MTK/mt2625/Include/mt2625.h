...
#define __MPU_PRESENT             1       /*!< MT2625 provides an MPU                        */
#define __NVIC_PRIO_BITS          7       /*!< MT2625 uses 7 Bits for the Priority Levels    */
//#define __Vendor_SysTickConfig    0       /*!< Set to 1 if different SysTick Config is used  */
#define __FPU_PRESENT             1       /*!< FPU present                                   */
#define CM4_HIF_IRQ               25
...
typedef enum IRQn {
    ...
    /****  MT2625 specific external/peripheral interrupt ****/
    MDSYS_IRQ_0                 =  0,
    MDSYS_IRQ_1                 =  1,
    MDSYS_IRQ_2                 =  2,
    MDSYS_IRQ_3                 =  3,
    ...
    L2_SW_ISR_IRQn              =  9,
    L1_SW_CRC_IRQn              =  10,
    MD_Reserved1_IRQn           =  11,
    FIRQ_IRQn                   =  12, //The MIRQ ISR will run WCT IDC code to stop TX immediately.
    OS_GPT_IRQn                 =  13,
    DMA_MCU_IRQn                =  14,
    DMA_SENSOR_IRQn             =  15,
    SPI_MST0_IRQn               =  16,
    ...
    SDIO_MST0_IRQn              =  20,
    SDIO_MST1_IRQn              =  21,
    SDIO_MST0_WAKEUP_IRQn       =  22,
    SDIO_MST1_WAKEUP_IRQn       =  23,
    TRNG_IRQn                   =  24,
    CRYPTO_IRQn                 =  25,
    UART0_IRQn                  =  26,
    UART1_IRQn                  =  27,
    ...
    BSIBPI0_IRQn                =  69,
    BSIBPI1_IRQn                =  70,
    CM4_reserved2_IRQn          =  71,
    CM4_reserved3_IRQn          =  72,
    CSCI_MD_READ_IRQn           =  73,
    CSCI_MD_WRITE_IRQn          =  74,
    CSCI_AP_READ_IRQn           =  75,
    CSCI_AP_WRITE_IRQn          =  76,
    IRQ_NUMBER_MAX              =  77
} IRQn_Type;
...
#include "system_mt2625.h"

/* MT2625 private config */
...
#define I2S_0_BASE           0xA0070000 /*I2S 0*/
#define I2S_1_BASE           0xA0080000 /*I2S 1*/
//#define BTIF_BASE            0xA0090000 /*Bluetooth interface*/
#define SPI_MASTER_0_BASE      0xA0090000 /*SPI_MASTER*/
#define SPI_MASTER_1_BASE      0xA00A0000 /*SPI_MASTER*/
#define SPI_SLAVE_BASE       0xA00B0000 /*SPI_SLAVE*/
#define SENSOR_UP_BASE       0xA0160000
#define SPI_SLAVE_PAD_BASE   0xA20E0000 /*SPI_SLAVE_PAD*/
...
#define I2C_0_BASE           0xA0110000 /*I2C_0*/
#define I2C_1_BASE           0xA0120000 /*I2C_1*/
#define I2C_2_BASE           0xA0130000 /*I2C_2*/
#define SENSOR_DMA_BASE      0xA0150000
#define PWM0_BASE            0xA2140000
#define PWM1_BASE            0xA2150000
#define PWM2_BASE            0xA2160000
#define PWM3_BASE            0xA2170000
#define SENSOR_FIFO_BASE     0xA2180000
#define SENSOR_TIMER_BASE    0xA2190000
#define USB_BASE             0xA1060000 /*USB MAC*/
#define USB_SIFSLV_BASE      0xA10708c0 /*USB PHY, SIFSLV*/

#define AUXADC_BASE          0xA0140000 /*Auxiliary ADC Unit*/
...
#define SDIO_MASTER_1_BASE     0xA1040000 /*SDIO MASTER*/
#define SDIO_SLAVE_BASE      0xA1050000 /*SDIO SLAVE*/
...
/*EMI Clock (CK) and Command(CS_B) IO Control */
//#define BBPLL_CTRL_BASE      0xA2020000 /*BBPLL control*/
#define XPLL_CTRL_BASE       0xA2050000 /*XPLL control*/
//#define CKSYS_BASE           0xA2040000 /*26M, clk switch control (clk divider related setting)*/
//#define CKSYS_XO_CLK_BASE    0xA2050000 /*26M, top clk control (dcm, cg)*/
...
#define KP_BASE              0xA21A0000 /*Keypad Scanner*/
#define OS_GPT_BASE             0xA21B0000 /*OS General Purpose Timer */
...
typedef struct {
    ...
    __IO uint32_t INT_active_high_low_0;
    __IO uint32_t INT_active_high_low_1;
    uint32_t RESERVED9[1];
    __IO uint32_t DCM_ctrl_reg;
    __IO uint32_t MEMsize_Config;
} CMSYS_CFG_T;
#define CMSYS_CFG  	((CMSYS_CFG_T *)CMSYS_CFG_BASE)
#define AHB_SYSBUS_BUFFERABLE 0x36
...
#define GDMA2_base  ((uint32_t)0xA0020200)

#define GDMA3_base  ((uint32_t)0xA0150100)

/*gdma global status base address definition
*/
#define GDMA_GLOAL1_base  ((uint32_t)0xA0020000)

#define GDMA_GLOAL2_base  ((uint32_t)0xA0150000)
...
#define PDMA4_base  ((uint32_t)0xA0020308)
#define PDMA5_base  ((uint32_t)0xA0020408)
#define PDMA6_base  ((uint32_t)0xA0020508)
#define PDMA7_base  ((uint32_t)0xA0020608)
#define PDMA8_base  ((uint32_t)0xA0150208)
#define PDMA9_base  ((uint32_t)0xA0150308)
#define PDMA10_base  ((uint32_t)0xA0150408)
#define PDMA11_base  ((uint32_t)0xA0150508)
#define PDMA12_base  ((uint32_t)0xA0150608)
#define PDMA13_base  ((uint32_t)0xA0150708)
#define PDMA14_base  ((uint32_t)0xA0150808)
#define PDMA15_base  ((uint32_t)0xA0150908)
...
#define PDMA_GLOAL2_base  ((uint32_t)0xA0150000)



/*virtual fifo dma base address definition
*/
#define VDMA16_base   ((uint32_t)0xA0020710)
#define VDMA17_base   ((uint32_t)0xA0020810)
#define VDMA18_base   ((uint32_t)0xA0020910)
#define VDMA19_base  ((uint32_t)0xA0020A10)
#define VDMA20_base  ((uint32_t)0xA0020B10)
#define VDMA21_base  ((uint32_t)0xA0020C10)
#define VDMA22_base  ((uint32_t)0xA0020D10)
#define VDMA23_base  ((uint32_t)0xA0020E10)
#define VDMA24_base  ((uint32_t)0xA0020F10)
#define VDMA25_base  ((uint32_t)0xA0021010)
#define VDMA26_base  ((uint32_t)0xA0021110)
#define VDMA27_base  ((uint32_t)0xA0021210)



/*virtual dma port address definition
*/
#define VDMA16_port    ((uint32_t)0xA1000000)
#define VDMA17_port    ((uint32_t)0xA1000100)
#define VDMA18_port    ((uint32_t)0xA1000200)
#define VDMA19_port   ((uint32_t)0xA1000300)
#define VDMA20_port   ((uint32_t)0xA1000400)
#define VDMA21_port   ((uint32_t)0xA1000500)
#define VDMA22_port   ((uint32_t)0xA1000600)
#define VDMA23_port   ((uint32_t)0xA1000700)
#define VDMA24_port   ((uint32_t)0xA1000800)
#define VDMA25_port   ((uint32_t)0xA1000900)
#define VDMA26_port   ((uint32_t)0xA1000A00)
#define VDMA27_port   ((uint32_t)0xA1000B00)
...
#define VDMA_GLOAL2_base  ((uint32_t)0xA0020004)
...
#define GDMA_GLOAL2                   ((GDMA_REGISTER_GLOBAL_T *) (GDMA_GLOAL2_base))
...
#define PDMA12                   ((PDMA_REGISTER_T *) (PDMA12_base))
#define PDMA13                  ((PDMA_REGISTER_T *) (PDMA13_base))
#define PDMA14                  ((PDMA_REGISTER_T *) (PDMA14_base))
#define PDMA15                   ((PDMA_REGISTER_T *) (PDMA15_base))
...
#define VDMA26                   ((VDMA_REGISTER_T *) (VDMA26_base))
#define VDMA27                   ((VDMA_REGISTER_T *) (VDMA27_base))
...
#define VDMA26_PORT                   ((VDMA_REGISTER_PORT_T *) (VDMA26_port))
#define VDMA27_PORT                   ((VDMA_REGISTER_PORT_T *) (VDMA27_port))
...
#define PDMA_CHANNEL4_OFFSET    (4)

#define PDMA_CHANNEL5_OFFSET    (6)

#define PDMA_CHANNEL6_OFFSET    (8)

#define PDMA_CHANNEL7_OFFSET    (10)

#define PDMA_CHANNEL8_OFFSET    (2)

#define PDMA_CHANNEL9_OFFSET    (4)

#define PDMA_CHANNEL10_OFFSET    (6)

#define PDMA_CHANNEL11_OFFSET    (8)

#define PDMA_CHANNEL12_OFFSET    (10)

#define PDMA_CHANNEL13_OFFSET    (12)

#define PDMA_CHANNEL14_OFFSET    (14)

#define PDMA_CHANNEL15_OFFSET    (16)
...
#define VDMA_CHANNEL16_OFFSET     (12)

#define VDMA_CHANNEL17_OFFSET    (14)

#define VDMA_CHANNEL18_OFFSET     (16)

#define VDMA_CHANNEL19_OFFSET    (18)

#define VDMA_CHANNEL20_OFFSET    (20)

#define VDMA_CHANNEL21_OFFSET    (22)

#define VDMA_CHANNEL22_OFFSET    (24)

#define VDMA_CHANNEL23_OFFSET    (26)

#define VDMA_CHANNEL24_OFFSET    (28)

#define VDMA_CHANNEL25_OFFSET    (30)

#define VDMA_CHANNEL26_OFFSET    (0)

#define VDMA_CHANNEL27_OFFSET    (2)
...
typedef struct {
    ...
    __IO  uint32_t GPT_CLRSTA;
    __IO  uint32_t GPT_WCSTA;
...
#define _GPT0_BASEADDR_ (_GPT_BASE_ + 0x010)
#define _GPT1_BASEADDR_ (_GPT_BASE_ + 0x040)
#define _GPT2_BASEADDR_ (_GPT_BASE_ + 0x070)
#define _GPT3_BASEADDR_ (_GPT_BASE_ + 0x0a0)
#define _GPT4_BASEADDR_ (_GPT_BASE_ + 0x0d0)
#define _GPT5_BASEADDR_ (_GPT_BASE_ + 0x100)

#define GPTGLB  ((GPT_REGISTER_GLOABL_T*)(_GPT_BASEADDR_))
#define GPT0 ((GPT_REGISTER_T*)(_GPT0_BASEADDR_))
#define GPT1 ((GPT_REGISTER_T*)(_GPT1_BASEADDR_))
#define GPT2 ((GPT_REGISTER_T*)(_GPT2_BASEADDR_))
#define GPT3 ((GPT_REGISTER_T*)(_GPT3_BASEADDR_))
#define GPT4 ((GPT_REGISTER_T*)(_GPT4_BASEADDR_))
#define GPT5 ((GPT_REGISTER_T*)(_GPT5_BASEADDR_))


#define _OS_GPT_BASE_ (OS_GPT_BASE)
#define _OS_GPT0_BASEADDR_ (_OS_GPT_BASE_ + 0x010)
#define _OS_GPT1_BASEADDR_ (_OS_GPT_BASE_ + 0x040)
#define OS_GPT0 ((GPT_REGISTER_T*)(_OS_GPT0_BASEADDR_))
#define OS_GPT1 ((GPT_REGISTER_T*)(_OS_GPT1_BASEADDR_))


#define OS_GPT3 ((GPT_REGISTER_T*)(OS_GPT_BASE+0x20))
...
typedef struct {
    ...
    union {
        struct {
            __IO uint8_t HS_EN;
            __IO uint8_t MASTER_CODE;
            __IO uint8_t HS_STEP_CNT_DIV;
            __IO uint8_t HS_SAMPLE_CNT_DIV;
        } HS_CELLS;
        __IO uint32_t HS;
    } HS_UNION;                  /* 60 */
...
#define _CKSYS_BASE_ADDR_       (BBPLL_CTRL_BASE + 0x220)
...
#define _CKSYS_XO_CLK_BASE_  (XPLL_CTRL_BASE+0xB00)
...
typedef struct {
    ...
    __IO EINT_CON_UNION EINT_CON_REGISTER[EINT_NUMBER_MAX]; /*0x100~0x17c EINT config register */
    uint32_t RESERVED22[32];

    __I uint32_t FIRQ_STA;               /* 0x200 EINT fast interrupt status register  */
    uint32_t RESERVED23[3];
    __O uint32_t FIRQ_MASK;              /* 0x210 EINT fast interrupt mask set register */
    __O uint32_t FIRQ_MASK_SET;          /* 0x214 EINT fast interrupt mask set register */
    __O uint32_t FIRQ_MASK_CLR;          /* 0x218 EINT fast interrupt mask clear register */
...
typedef struct {
    ...
    __I uint32_t RTC_INT_CNT; /* RTC internal counter register,             Address offset: 0x38 */
    union {
        struct {
            __IO uint8_t PAD_EINT_CON;   /*  */
            __IO uint8_t EINT_CON; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_EINT_CELLS;
    ...
    union {
        ...
        __IO uint32_t RTC_SPAR0; /* Spare register 0 for specific purpose,                                        Address offset: 0x58 */
    } RTC_SPAR0_UNION;
    union {
        struct {
        ...
        __IO uint32_t RTC_SPAR1; /* Spare register 1 for specific purpose,                                        Address offset: 0x5C */
    } RTC_SPAR1_UNION;
    union {
        struct {
            __IO uint8_t RTC_SPAR2_0;   /*  */
            __IO uint8_t RTC_SPAR2_1; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_SPAR2_CELLS;
        __IO uint32_t RTC_SPAR2; /* Spare register 2 for specific purpose,                Address offset: 0x60 */
    } RTC_SPAR2_UNION;
    union {
        struct {
            __IO uint8_t RTC_SPAR3_0;   /*  */
            __IO uint8_t RTC_SPAR3_1; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_SPAR3_CELLS;
        __IO uint32_t RTC_SPAR3; /* Spare register 3 for specific purpose,                Address offset: 0x64 */
    } RTC_SPAR3_UNION;
    ...
    union {
        struct {
            __IO uint8_t PAD_GPIO_0_CON;   /*  */
            __IO uint8_t PAD_GPIO_1_CON; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_GPIO_CON0_CELLS;
        __IO uint32_t RTC_GPIO_CON0; /* GPIO control register0,                   Address offset: 0x78 */
    } RTC_GPIO_CON0_UNION;
    union {
        struct {
            __IO uint8_t GPIO_BBPU;   /*  */
            __O uint8_t GPIO_BBPU_KEY; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_GPIO_CON1_CELLS;
        __IO uint32_t RTC_GPIO_CON1; /* GPIO control register1,                   Address offset: 0x7C */
    } RTC_GPIO_CON1_UNION;
    union {
        struct {
            __IO uint8_t MD_AL_MASK;   /*  */
            __IO uint8_t MD_AL_EN; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_MD_AL_MASK_CELLS;
        __IO uint32_t RTC_MD_AL_MASK; /* RTC alarm mask for MD,                               Address offset: 0x80 */
    } RTC_MD_AL_MASK_UNION;
    union {
        struct {
            __IO uint8_t MD_AL_SECOND;   /*  */
            __IO uint8_t MD_AL_MINUTE; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_MD_AL0_CELLS;
        __IO uint32_t RTC_MD_AL0; /* RTC alarm setting register0 for MD,          Address offset: 0x84 */
    } RTC_MD_AL0_UNION;
    union {
        struct {
            __IO uint8_t MD_AL_HOUR;   /*  */
            __IO uint8_t MD_AL_DOM; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_MD_AL1_CELLS;
        __IO uint32_t RTC_MD_AL1; /* RTC alarm setting register1 for MD,              Address offset: 0x88 */
    } RTC_MD_AL1_UNION;
    union {
        struct {
            __IO uint8_t MD_AL_DOW;   /*  */
            __IO uint8_t MD_AL_MONTH; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_MD_AL2_CELLS;
        __IO uint32_t RTC_MD_AL2; /* RTC alarm setting register2 for MD,                  Address offset: 0x8C */
    } RTC_MD_AL2_UNION;
    union {
        struct {
            __IO uint8_t MD_AL_YEAR;   /*  */
            __IO uint8_t MD_AL_MS; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_MD_AL3_CELLS;
        __IO uint32_t RTC_MD_AL3; /* RTC alarm setting register3 for MD,                  Address offset: 0x90 */
    } RTC_MD_AL3_UNION;
    union {
        struct {
            __IO uint8_t RTC_SPAR_REG_0;   /*  */
            __IO uint8_t RTC_SPAR_REG_1; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_SPAR_REG_CELLS;
        __IO uint32_t RTC_SPAR_REG; /* RTC spare register,                Address offset: 0x94 */
    } RTC_SPAR_REG_UNION;
    union {
        struct {
            __IO uint8_t RTC_SPAR4_0;   /*  */
            __IO uint8_t RTC_SPAR4_1; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_SPAR4_CELLS;
        __IO uint32_t RTC_SPAR4; /* Spare register 4 for specific purpose,                Address offset: 0x98 */
    } RTC_SPAR4_UNION;
    union {
        struct {
            __IO uint8_t RTC_SPAR5_0;   /*  */
            __IO uint8_t RTC_SPAR5_1; /*  */
            __IO uint8_t RESERVED[2];
        } RTC_SPAR5_CELLS;
        __IO uint32_t RTC_SPAR5; /* Spare register 5 for specific purpose,                Address offset: 0x9C */
    } RTC_SPAR5_UNION;
} RTC_REGISTER_T;
...
typedef struct {
    ...
    __IO uint32_t WDT_INT;
    __IO uint32_t WDT_STA;
    __IO uint32_t WDT_SW_RSTSYS;
    union {
        struct {
            __IO uint16_t MDSYS_SW_RST;
            __IO uint16_t MODULE1_SW_RST;
        } WDT_RST0_CELLS;
    ...
    __IO uint32_t WDT_CM4_RST_INTERVAL;
...
#define PWM_CLK_SEL_48M_MASK          (0x2<< PWM_CLK_SEL_OFFSET)
...
typedef struct {
    __IO uint32_t RW[7];                   /*!< GPIO RW register */
    uint32_t  RESERVED1;                 /*!< reserved */
    __IO uint32_t SET[7];                  /*!< GPIO set register */
    uint32_t  RESERVED2;                 /*!< reserved */
    __IO uint32_t CLR[7];                  /*!< GPIO clear register */
...
typedef struct {
    __IO uint32_t RW[2];                 /*!< GPIO driving register */
    uint32_t  RESERVED[4];               /*!< reserved */
} GPIO_DRV_REGISTER_T;
typedef struct {
    __IO uint32_t RW[2];                 /*!< GPIO driving register */
    uint32_t  RESERVED[4];               /*!< reserved */
} GPIO_RDSEL_REGISTER_T;
typedef struct {
    __IO uint32_t RW[4];                 /*!< GPIO driving register */
} GPIO_TDSEL_REGISTER_T;
typedef struct {
    GPIO_REGISTER_2_T       GPIO_DIR;               /*!< GPIO direction register */
    GPIO_REGISTER_2_T       GPIO_DOUT;              /*!< GPIO output data register */
...
typedef struct {
    GPIO_DRV_REGISTER_T     GPIO_DRV;               /*!< GPIO DRV register */
