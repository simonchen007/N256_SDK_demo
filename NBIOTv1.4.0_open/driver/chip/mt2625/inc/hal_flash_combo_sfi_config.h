...
COMBO_MEM_HW_TYPE_MODIFIER CMEMEntrySFIList COMBO_MEM_HW_INST_NAME = {   // (to be renamed by SFI owner)
    ...
    SFI_COMBO_COUNT,   // defined in custom_Memorydevice.h
    {
           ...
           // GD External Serial Flash test
            ...
            {
                SPI, 1, 0x06, SPI, 3, 0x01, 0x02, 0x02,
                SPI, 2, 0x05, 0x01, SPI, 1, 0x38, QPI,
                5, 0x77, 0x0, 0x0, 0x0, 0x40, QPI, 2,
                0xC0, 0x12, SF_UNDEF, 0, 0, 0, 0, 0,
            },
            {
        ...
        },
        {
            ...
            {
                SPI, 1, 0x06, SPI, 2, 0x31, 0x02, SPI,
                2, 0x05, 0x01, SPI, 5, 0x77, 0x00, 0x00,
