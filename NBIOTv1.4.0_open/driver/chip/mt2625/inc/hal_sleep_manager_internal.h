...
#define SLEEP_MANAGEMENT_SLEEP_OVERHEAD_TEST    0
#define SLEEP_MANAGEMENT_SLEEP_DUMP_PMU         0
...
// #define for low power setting
#define TOP_MISC_CFG_BASE     0xA2010000
#define SYSTEM_INFOD    ((volatile uint32_t*)(TOP_MISC_CFG_BASE+0x0040))

#define IO_CFG_1_BASE  0xA20D0000
#define IO_CFG_1_PD_CFG0_SET    ((volatile uint32_t*)(IO_CFG_1_BASE+0x034))
#define IO_CFG_1_PD_CFG0_CLR    ((volatile uint32_t*)(IO_CFG_1_BASE+0x038))
#define IO_CFG_1_PU_CFG0_SET    ((volatile uint32_t*)(IO_CFG_1_BASE+0x04C))
#define IO_CFG_1_PU_CFG0_CLR    ((volatile uint32_t*)(IO_CFG_1_BASE+0x050))
...
/* *0xE0181000 = 0x10000023 */
/* *0xE0181004 = 0x0 */
/*sysram remap */
/* *0xE0181008 = 0x1420001 */
/* *0xE018100C = 0x04200000 */
#define __ENTER_LIGHT_SLEEP(ptr) __asm volatile(  \
    "MOV    r3,         %0              \n"\
    "MOV    r2,         pc              \n"\
    "ADD    r2,         r2,#16          \n"\
    "ORR    r2,         r2,#1           \n"\
...
typedef struct {
    uint32_t    lock_sleep_all_low;
    uint32_t    lock_sleep_all_high;
    uint32_t    lock_sleep_deep_low;
    uint32_t    lock_sleep_deep_high;
    uint32_t    user_handle_resoure_low;
    uint32_t    user_handle_resoure_high;
...
typedef void(* sleep_management_suspend_callback_t)(void *data, uint32_t mode);
typedef void(* sleep_management_resume_callback_t)(void *data, uint32_t mode);
...
void deep_sleep_cmsys_backup();
void deep_sleep_cmsys_restore();
...
void sleep_management_suspend_callback(uint32_t mode);
void sleep_management_resume_callback(uint32_t mode);
...
void sleep_management_sleeplock_control(uint8_t handle_index, hal_sleep_lock_t level, sleep_management_lock_sleep_t control);
