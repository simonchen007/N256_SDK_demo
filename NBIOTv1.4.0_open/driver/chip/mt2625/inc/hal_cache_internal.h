...
//#define HAL_CACHE_CALCULATE_HIT_RATE
...
#ifdef HAL_CACHE_CALCULATE_HIT_RATE
typedef struct {
...
void hal_cache_hit_rate_stop(void);

void hal_cache_hit_rate_start(void);

void hal_cache_hit_rate_get(hal_cache_hit_rate_t * cache_hit_rate);
