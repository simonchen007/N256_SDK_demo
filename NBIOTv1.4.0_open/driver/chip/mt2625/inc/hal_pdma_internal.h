...
*/
#define PDMA_NUMBER   12

/*vdma channel number definition
*/
#define VDMA_NUMBER   12

/*all dma channel number definition,DMA1~DMA18
*/
#define DMA_NUMBER   27
...
typedef enum {
    ...
    PDMA_START_CHANNEL = 3,                   /**< peripheral dma start channel  */
    PDMA_USB1_TX = PDMA_START_CHANNEL,         /**< peripheral dma channel 4*/
    PDMA_USB1_RX = 4,                          /**< peripheral dma channel 5 */
    PDMA_USB2_TX = 5,                         /**< peripheral dma channel 6 */
    PDMA_USB2_RX = 6,                         /**< peripheral dma channel 7 */
    PDMA_I2C0_TX = 7,                          /**< peripheral dma channel 8*/
    PDMA_I2C0_RX = 8,                          /**< peripheral dma channel 9 */
    PDMA_I2C1_TX = 9,                         /**< peripheral dma channel 10 */
    PDMA_I2C1_RX = 10,                         /**< peripheral dma channel 11 */
    PDMA_I2C2_TX = 11,                          /**< peripheral dma channel 12*/
    PDMA_I2C2_RX = 12,                          /**< peripheral dma channel 13 */
    PDMA_USIM_TX = 13,                         /**< peripheral dma channel 14 */
    PDMA_USIM_RX = 14,                         /**< peripheral dma channel 15 */
...
typedef enum {
    VDMA_START_CHANNEL = 15,               /**< virtual fifo dma start channel */		
    VDMA_UART2TX = VDMA_START_CHANNEL,    /**<virtual fifo  dma channel 16 */
    VDMA_UART2RX = 16,                    /**< virtual fifo dma channel 17*/
    VDMA_UART1TX = 17,                    /**< virtual fifo dma channel 18 */
    VDMA_UART1RX = 18,                    /**<virtual fifo  dma channel 19 */
    VDMA_UART0TX = 19,                    /**<virtual fifo  dma channel 20 */
    VDMA_UART0RX = 20,                    /**< virtual fifo dma channel 21*/
    VDMA_I2S0TX = 21,                      /**< virtual fifo dma channel 22 */
    VDMA_I2S0RX = 22,                      /**<virtual fifo  dma channel 23 */
    VDMA_I2S1TX = 23,                      /**<virtual fifo  dma channel 24 */
    VDMA_I2S1RX = 24,                      /**< virtual fifo dma channel 25*/
    VDMA_UART3TX = 25,                      /**<virtual fifo  dma channel 26 */
    VDMA_UART3RX = 26,                      /**< virtual fifo dma channel 27*/
...
#define SENSOR_GDMA_START_NUMBER 2

#define SENSOR_PDMA_START_NUMBER 5
...
void sensor_dma_interrupt_hander(hal_nvic_irq_t irq_number);
