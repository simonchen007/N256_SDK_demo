...
typedef struct {
    ...
    uint32_t    hwfte0er_interrupte_enable_mask;
    uint32_t    hwfre0er_interrupte_enable_mask;
    uint32_t    hwfre1er_interrupte_enable_mask;
...
typedef struct {
    ...
    uint32_t    hwfte0sr_interrupte_status;    //ORG_SDIO_HWFTE0SR                    DMA    0110
    uint32_t    hwfre0sr_interrupte_status;    //ORG_SDIO_HWFRE0SR                    DMA    0130
    uint32_t    hwfre1sr_interrupte_status;    //ORG_SDIO_HWFRE1SR                    DMA    0134
    uint32_t    hwfisr_interrupte_status;
...
#endif /*__HAL_SDIO_SLAVE_INTERNAL_H__*/
