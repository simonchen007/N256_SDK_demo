...
#define SDIO_DEFAULT_MAX_SPEED    (26000)  /*The max speed is 26MHZ in default.*/

#define MSDC_CLOCK_SOURCE_52M  (52000)  /*52000KHz*/
#define MSDC_CLOCK_SOURCE_26M  (26000)  /*52000KHz*/


#define MSDC0_REG  ((msdc_register_t *)SDIO_MASTER_BASE) /*defined in mt2625.h*/
#define MSDC1_REG ((msdc_register_t *)SDIO_MASTER_1_BASE) /*defined in mt2625.h*/
...
#define MSDC_TXFIFOCNT(msdc_register_base)    ((msdc_register_base->MSDC_FIFOCS & MSDC_FIFOCS_TXCNT) >> 16)
#define MSDC_RXFIFOCNT(msdc_register_base)    ((msdc_register_base->MSDC_FIFOCS & MSDC_FIFOCS_RXCNT) >> 0)
#define MSDC_IS_SDC_BUSY(msdc_register_base)  (msdc_register_base->SDC_STS & SDC_STS_SDCBUSY)
#define MSDC_IS_CMD_BUSY(msdc_register_base)  (msdc_register_base->SDC_STS & SDC_STS_CMDBUSY)
...
#define MSDC_CFG_CCKSB          (0x1  << 7)     /* R  */    // MS/SD card clock stability
#define MSDC_CFG_CKDIV          (0xfff << 8)    /* RW */
#define MSDC_CFG_CCKMD          (1 << 16)
