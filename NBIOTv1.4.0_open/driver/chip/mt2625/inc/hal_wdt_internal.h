...
#define WDT_SYSTEM_SW_RST_KEY               (0x18)
#define WDT_MDSYS_SW_RST_KEY                (0x19)
#define WDT_MODULE1_SW_RST_KEY              (0x1a)
#define WDT_SDCTL_SW_RST_KEY                (0x1b)
#define WDT_MODULE3_SW_RST_KEY              (0x1c)
#define WDT_JTAG_RST_MASK_KEY               (0x1d)
#define WDT_AIRCR_RST_MASK_KEY              (0x1e)
#define WDT_PCM_RST_KEY                     (0x1f)
#define WDT_PMU_RST_KEY                     (0x21)
#define WDT_CM4_RST_INTERVAL_KEY            (0x22)
#define WDT_RETENTION_FALG0_KEY             (0x23)
#define WDT_RETENTION_FALG1_KEY             (0x24)
#define WDT_RETENTION_FALG2_KEY             (0x25)
#define WDT_RETENTION_FALG3_KEY             (0x26)
#define WDT_RETENTION_FALG4_KEY             (0x27)
#define WDT_RETENTION_FALG5_KEY             (0x28)
...
void wdt_resetb_out(uint32_t reset_time_us);
