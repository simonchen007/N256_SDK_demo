...
/*****************************************************************************
* Defines for module sub-features.
...
#define HAL_I2S_SUPPORT_DMA                     /* Supports DMA. */
#define HAL_I2S_FEATURE_MULTI_I2S               /* Supports multiple I2S connections. */
#endif

#ifdef HAL_GPIO_MODULE_ENABLED
#define HAL_GPIO_FEATURE_PUPD              /* The pull state of the pin can be configured with different resistors through different combinations of GPIO_PUPD_x,GPIO_RESEN0_x and GPIO_RESEN1_x. For more details, please refer to hal_gpio.h. */
...
#define HAL_EINT_FEATURE_FIRQ                /* Supports EINT firq feature */
#endif
...
#define HAL_KEYPAD_FEATURE_POWERKEY             /* Supports the key of powekey feature. */
//#endif
//#endif
#endif
...
#define HAL_RTC_FEATURE_ELAPSED_TICK            /* Supports calculate the elapsed tick number between two time points. */
#define HAL_RTC_FEATURE_RETENTION_SRAM          /* Supports retention sram feature in normal mode and retention mode. */
#define HAL_RTC_FEATURE_SW_TIMER                /* Supports RTC software RTC timer. */
#endif
...
#define HAL_SLEEP_MANAGER_SUPPROT_DEEPSLEEP_LOCK        /* Supports two level sleep lock for deep sleep feature */

#ifdef HAL_UART_MODULE_ENABLED
#define HAL_UART_FEATURE_VFIFO_DMA_TIMEOUT        /* Supports configurable timeout value setting */
#define HAL_UART_FEATURE_3M_BAUDRATE       /* Supports UART 3M baud rate configuration. */
#endif

#ifdef HAL_WDT_MODULE_ENABLED
//#define MTK_SYSTEM_HANG_CHECK_ENABLE     //always keep this feature enabled
#define EXCEPTION_AUTO_REBOOT            //support auto-reboot after exception dump
#define MTK_WDT_TIMEOUT_DEBUG            //debug watchdog un-expected timeout issue
#endif

#ifdef MTK_SYSTEM_HANG_CHECK_ENABLE
#define SYSTEM_HANG_CHECK_WDT_MODE         HAL_WDT_MODE_INTERRUPT
#define SYSTEM_HANG_CHECK_TIMEOUT_DURATION 30
#endif
