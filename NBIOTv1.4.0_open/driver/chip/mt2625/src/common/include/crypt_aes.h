...
#define AES_KEY_SOURCE_EFUSE_0      (0)
#define AES_KEY_SOURCE_EFUSE_1      (1)
#define AES_KEY_SOURCE_SW           (2)
#define AES_KEY_SOURCE_HW_RTL       (3)
#define AES_KEY_SOURCE_HW_CKDF_0    (4)
#define AES_KEY_SOURCE_HW_CKDF_1    (5)
#define AES_KEY_SOURCE_FEEDBACK    (6)
#define AES_KEY_SOURCE_NUM          (7)
