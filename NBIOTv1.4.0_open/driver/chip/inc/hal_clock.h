...
/**
 * @brief       This function sets the MPLL frequency hopping and spread spectrum.
 * @param[in]   start is the offset of the frequency hopping. The unit is in percentage.
 * @param[in]   range is the spread spectrum range based on "start" parameter. The unit is in percentage.
 * @return      #HAL_CLOCK_STATUS_OK, if the operation completed successfully.\n
 *              #HAL_CLOCK_STATUS_INVALID_PARAMETER, if the input parameter is invalid.\n
 */
...
/**
 * @brief       This function enables FREF force output.
 * @param[in]   enable specifies whether the FREF force output.
 * @return      #HAL_CLOCK_STATUS_OK, if the operation completed successfully.\n
 */
...
/**
 * @brief       This function sets the DCXO control for factory calibration.
 */
