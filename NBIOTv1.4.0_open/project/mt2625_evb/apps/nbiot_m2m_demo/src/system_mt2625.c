...
{
    SystemCoreClock = 1000 * hal_clock_get_freq_meter(19, 0);
}
...
void SystemInit(void)
{
    ...
    /* enable SYSBUS bufferable */
    CMSYS_CFG->AHB_bufferable = AHB_SYSBUS_BUFFERABLE;
}
...
void CachePreInit(void)
{
    ...
    switch (TCM_LENGTH + TCM_MD_LENGTH) {
        /* 64K TCM/32K CACHE */
        case 0x00010000:
