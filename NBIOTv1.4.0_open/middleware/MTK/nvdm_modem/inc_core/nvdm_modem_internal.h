...
extern bool g_modem_nvdm_init_status;
extern uint32_t g_nvdm_modem_peb_size;
...
typedef struct {
    ...
    uint8_t verno; /* version number of data */
    ...
    nvdm_modem_data_item_type_t type; /* display type of data item, it can be type of binary/hex/decimal/string/structure */
...
extern uint32_t g_modem_max_data_item_size;
extern uint32_t g_modem_max_group_name_size;
extern uint32_t g_modem_max_data_item_name_size;
...
void nvdm_modem_peb_io_read(int32_t pnum, int32_t offset, uint8_t *buf, int32_t len);
void nvdm_modem_peb_io_write(int32_t pnum, int32_t offset, const uint8_t *buf, int32_t len);
void nvdm_modem_peb_io_erase(int32_t pnum);
...
nvdm_modem_status_t nvdm_modem_read_data_item(const char *group_name, const char *data_item_name, nvdm_modem_data_item_type_t *type, uint8_t *buffer, uint32_t *size);
nvdm_modem_status_t nvdm_modem_write_data_item(const char *group_name, const char *data_item_name, nvdm_modem_data_item_type_t type, const uint8_t *buffer, uint32_t size);
nvdm_modem_status_t nvdm_modem_delete_data_item(const char *group_name, const char *data_item_name);
nvdm_modem_status_t nvdm_modem_get_data_item_size(const char *group_name, const char *data_item_name, uint32_t *size);
nvdm_modem_status_t nvdm_modem_is_data_item_found(const char *group_name, const char *data_item_name);
nvdm_modem_status_t nvdm_modem_query_data_item_count(uint32_t *count);
nvdm_modem_status_t nvdm_modem_query_all_data_item(nvdm_modem_data_item_info_t *info_list, uint32_t count);
