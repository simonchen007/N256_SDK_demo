...
/* enable SMS related AT commands (3GPP spec v27.005), but disable by default due to operator doesn't support on NB-IoT product. */
//#define __RIL_SMS_COMMAND_SUPPORT__
 ...
 */
typedef struct {
    char *time; /**< The response time in "yy/MM/dd,hh:mm:ss¡Àzz" format. */
} ril_clock_rsp_t;
/**
 * @}
 */
...
typedef struct {
    ...
    int32_t lac;    /**< String type, two bytes location area code in hexadecimal format. */
...
/**
 * @brief This defines data structure for URC of "+CEDRXS".
 */
typedef struct {
    int32_t act_type; /**< The type of access technology. */
    char *requested_eDRX_value; /**< The eDRX value. */
