...
#define IPERF_COMMAND_BUFFER_SIZE (64) // 4 bytes align
...
void iperf_register_callback(iperf_type_t type, iperf_callback_t callback);
int iperf_format_transform(char *param);
bool is_iperf_running(iperf_type_t type);
