...
extern apb_proxy_queue_handle_t g_apb_proxy_internal_userdata_tx_queue;
extern apb_proxy_queue_handle_t g_apb_proxy_internal_userdata_rx_queue;
 ...
 ********************************************************************************/
apb_proxy_status_t apb_proxy_create_user_data_queue(void);
/************************************************************************************
 * @brief     Create user data message queue in AP Bridge Proxy .
 ...
 * @return    None
 ************************************************************************************/
void apb_proxy_delete_user_data_queue(void);
/************************************************************************************
