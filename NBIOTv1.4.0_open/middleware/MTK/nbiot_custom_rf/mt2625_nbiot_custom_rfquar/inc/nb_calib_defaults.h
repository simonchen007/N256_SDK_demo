...
#define NB_CAL_DATA_TEMP_SENSOR_ADC_DATA_LOW_BOUND_SEG_1    (uint16_t)86
...
#define NB_CAL_DATA_TEMP_SENSOR_ADC_DATA_LOW_BOUND_SEG_4    (uint16_t)210
...
#define NB_CAL_DATA_TEMP_SENSOR_ADC_DATA_LOW_BOUND_SEG_5    (uint16_t)239
...
#define NB_CAL_DATA_TEMP_SENSOR_ADC_DATA_LOW_BOUND_SEG_6    (uint16_t)267
...
#define NB_CAL_DATA_TEMP_SENSOR_ADC_DATA_LOW_BOUND_SEG_7    (uint16_t)296
...
#define NB_CAL_DATA_TEMP_SENSOR_ADC_DATA_LOW_BOUND_SEG_8    (uint16_t)335
...
#define NB_CAL_DATA_TEMP_SENSOR_ADC_DATA_HIGH_BOUND_SEG_8    (uint16_t)420
