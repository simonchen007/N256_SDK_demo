...
/* PA Bias data values for each gain modes of GPIO/BPI controlled PA in Band 5 0804*/
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_LOW_DEFAULT_BAND_5          ((uint8_t)0x11) /* VMODE0 (BPI1) = High, VMODE1 (BPI4) =  High */
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA2_LOW_DEFAULT_BAND_5          ((uint8_t)0x0) /* Unused */

#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_MID_LOW_DEFAULT_BAND_5      ((uint8_t)0x1) /* VMODE0 (BPI1) = High, VMODE1 (BPI4) =  Low */
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA2_MID_LOW_DEFAULT_BAND_5      ((uint8_t)0x0) /* Unused */

#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_MID_DEFAULT_BAND_5          ((uint8_t)0x1) /* VMODE0 (BPI1) = High, VMODE1 (BPI4) =  Low */
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA2_MID_DEFAULT_BAND_5          ((uint8_t)0x0) /* Unused */

#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_MID_HIGH_DEFAULT_BAND_5     ((uint8_t)0x1) /* VMODE0 (BPI1) = High, VMODE1 (BPI4) =  Low */
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA2_MID_HIGH_DEFAULT_BAND_5     ((uint8_t)0x0) /* Unused */

#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_HIGH_DEFAULT_BAND_5         ((uint8_t)0x0) /* VMODE0 (BPI1) = Low, VMODE1 (BPI4) =  Low */
...
/* PA Bias data values for each gain modes of GPIO/BPI controlled PA in Band 8 0804*/
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_LOW_DEFAULT_BAND_8      ((uint8_t)0x11) /* VMODE0 (BPI1) = High, VMODE1 (BPI4) =  High */
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA2_LOW_DEFAULT_BAND_8      ((uint8_t)0x0) /* Unused */

#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_MID_LOW_DEFAULT_BAND_8  ((uint8_t)0x1) /* VMODE0 (BPI1) = High, VMODE1 (BPI4) =  Low */
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA2_MID_LOW_DEFAULT_BAND_8  ((uint8_t)0x0) /* Unused */

#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_MID_DEFAULT_BAND_8      ((uint8_t)0x1) /* VMODE0 (BPI1) = High, VMODE1 (BPI4) =  Low */
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA2_MID_DEFAULT_BAND_8      ((uint8_t)0x0) /* Unused */

#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_MID_HIGH_DEFAULT_BAND_8 ((uint8_t)0x1) /* VMODE0 (BPI1) = High, VMODE1 (BPI4) =  Low */
#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA2_MID_HIGH_DEFAULT_BAND_8 ((uint8_t)0x0) /* Unused */

#define NB_CAL_DATA_HW_VAR0_PA_BIAS_GPIO_DATA1_HIGH_DEFAULT_BAND_8     ((uint8_t)0x0) /* VMODE0 (BPI1) = Low, VMODE1 (BPI4) =  Low */
