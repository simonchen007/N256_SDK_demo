...
extern const int16_t  nb_cal_data_temp_reciprocal_slope[NB_CAL_TEMPERATURE_SEG_COUNT] =
{ \
...
#ifdef NB_RF_CUSTOM_SINGLE_PA
  &rf_hw_var0_default_cal_db, /* If no HW ID detection, use HW VAR1 - ES1 FEM */
#else
  &rf_hw_var1_default_cal_db, /* If no HW ID detection, use HW VAR1 - ES1 FEM */
#endif
