...
#ifdef NB_RF_CUSTOM_SINGLE_PA
  &nb_hw_var0_rffe_custom_db,   /* Customization database when feature disabled */
#else
  &nb_hw_var1_rffe_custom_db,   /* Customization database when feature disabled */ 
#endif
