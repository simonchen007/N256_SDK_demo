...
#ifndef __ATCI_APB_PROXY_ADAPTER__H__
#define __ATCI_APB_PROXY_ADAPTER__H__
#include "stdint.h"
#include "apb_proxy.h"
...
typedef apb_proxy_status_t atci_status_t;

#ifndef ATCI_STATUS_DEF
#define ATCI_STATUS_DEF
#define ATCI_STATUS_ERROR APB_PROXY_STATUS_ERROR /**< An error occurred during the function call. */
#define ATCI_STATUS_OK    APB_PROXY_STATUS_OK /**< No error occurred during the function call. */
#define ATCI_STATUS_REGISTRATION_FAILURE -1 /**< Failed to register the AT command handler table. */
#endif

#define ATCI_LOCAL_QUEUE_LENGTH        (8)

#ifndef ATCI_CMD_MODE
#define ATCI_CMD_MODE
#define ATCI_CMD_MODE_READ APB_PROXY_CMD_MODE_READ /**< Read mode command, such as "AT+CMD?". */
#define ATCI_CMD_MODE_ACTIVE APB_PROXY_CMD_MODE_ACTIVE /**< Active mode command, such as "AT+CMD". */
#define ATCI_CMD_MODE_EXECUTION APB_PROXY_CMD_MODE_EXECUTION /**< Execute mode command, such as "AT+CMD=<op>". */
#define ATCI_CMD_MODE_TESTING APB_PROXY_CMD_MODE_TESTING /**< Test mode command, such as "AT+CMD=?". */
#define ATCI_CMD_MODE_INVALID APB_PROXY_CMD_MODE_INVALID /**< The input command doesn't belong to any of the four types. */
#endif/*ATCI_CMD_MODE*/
...
typedef struct {
    ...
    uint32_t cmd_id;                                      /**< The command id will be generated by framework.*/
} atci_response_t;

typedef apb_proxy_parse_cmd_param_t atci_parse_cmd_param_t;
 ...
 */
typedef apb_proxy_at_cmd_handler at_cmd_hdlr_fp;
...
#endif/*__ATCI_APB_PROXY_ADAPTER__H__*/
