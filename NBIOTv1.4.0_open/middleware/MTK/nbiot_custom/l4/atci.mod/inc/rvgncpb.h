...
ResultCode_t vgGnCPBF ( CommandLine_t *commandBuffer_p,
                         const VgmuxChannelNumber entity);
ResultCode_t vgGnMUPBSYNC(  CommandLine_t *commandBuffer_p, 
                            const VgmuxChannelNumber entity);
ResultCode_t vgMUpbhKey   (CommandLine_t *commandBuffer_p,
                            const VgmuxChannelNumber  entity);
ResultCode_t vgGnMupbcfg(   CommandLine_t *commandBuffer_p,
                            const VgmuxChannelNumber entity);
ResultCode_t vgGnMupbgas(   CommandLine_t *commandBuffer_p,
                            const VgmuxChannelNumber entity);
ResultCode_t vgGnMupbaas(   CommandLine_t *commandBuffer_p,
                            const VgmuxChannelNumber entity);
