 ...
 **************************************************************************/
 /****************************************************************************
  * This file is used for manage NVDM item verno information structure
  ****************************************************************************/
#ifndef __NVDM_VERNO_H__
#define __NVDM_VERNO_H__
#include <stdint.h>
#include <stdbool.h>
...
typedef struct
{
     ...
     char item_name[32];
     uint8_t version;
} nvdm_item_verno_info_t;

typedef struct
{
    const nvdm_item_verno_info_t * table;
    uint32_t                 item_num;
    uint16_t               * name_value;
    bool                     init_flag;
}nvdm_item_verno_table_info_t;
