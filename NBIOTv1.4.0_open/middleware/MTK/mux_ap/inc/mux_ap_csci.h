...
#ifndef __MUX_AP_CSCI_H__
#define __MUX_AP_CSCI_H__
...
void mux_ap_csci_send_user_data(uint32_t channel, uint8_t *packet, uint32_t length, void *user_data, bool resend);
