...
#define SAMPLE_A_INSTANCE_BITMAP      "101"

#define SAMPLE_B_INSTANCE_COUNT        5
#define SAMPLE_B_INSTANCE_BITMAP      "11011"
...
#define ONENET_ASYN_SAMPLE_LOG(x, ...)    LOG_I(onenet_asyn_sample, x, ##__VA_ARGS__)
#else
#define ONENET_ASYN_SAMPLE_LOG(x, ...)
#endif

bool cis_asyn_get_shutdown(void);

void cis_asyn_set_shutdown(bool shutdown);

int cis_asyn_main(void);
