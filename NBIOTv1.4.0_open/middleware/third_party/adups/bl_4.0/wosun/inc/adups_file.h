...
adups_extern adups_int32 adups_write_backup_file(adups_uint8* src, adups_uint32 size);
adups_extern adups_int32 adups_read_backup_file(adups_uint8* dest, adups_uint32 size);
#endif