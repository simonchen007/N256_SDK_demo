...
adups_extern adups_int32 adups_wstrcmp(const adups_wchar * string1, const adups_wchar * string2);
...
adups_extern adups_uint32 adups_dt_curtime2utcsec(Adups_time_struct *currTime);
adups_extern adups_uint32 abup_mktime(void);
#endif
