...
extern void MD5Init PROTO_LIST ((ADUPS_MD5_CTX *));
extern void MD5Update PROTO_LIST((ADUPS_MD5_CTX *, unsigned char *, unsigned int));
extern void MD5Final PROTO_LIST ((unsigned char [16], ADUPS_MD5_CTX *));
